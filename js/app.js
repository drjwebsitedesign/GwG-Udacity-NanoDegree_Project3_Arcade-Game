...
//CLICK THE GAME THEME BUTTON TO DISPLAY THE HIDDEN GAME THEME AND RULES. TEXT DYNAMICALLY HIDES AGAIN AFTER 14 SECONDS.
...
//THE METHODS NESTED INSIDE THIS CLASS ARE: CONSTRUCTOR, DELTA TIME UPDATES, CANVAS RENDERING, COLLISION DETECTION, KEY CONTROLS, "WIN GAME/RESET" FUNCTIONS. 
class Player {
    constructor(x, y) {
        this.x = x;
        this.y = y;    
...
//DYNAMICALLY HIDE THE GAME TITLE DURING THE GAME TO REMOVE DISTRACTIONS. SHOW TITLE AGAIN AT BEGINNING OF EACH NEW GAME.
function gameTitle(){
